...
export default function ResultsPage() {
  ...
  function getCerclesDataWithNames() {
    ...
    Object.keys(data?.data().cercles).forEach((cercleId: any) => {
      cerclesWithNames[cercleId] = {
            ...
            if (comitard.encheres) {
              for (const enchere_id in comitard.encheres) {
                ...
                encheres.push({
                  ...
                  enchere: `${
                    getCerclesDataWithNames()[enchere.sender]?.name || "Erreur"
                  } avec ${enchere.vote} fûts`,
                  vote: enchere.vote,
                  house: `${
                    getCerclesDataWithNames()[cercle_id]?.name || "Erreur"
                  }`,
        ...
        if (cercle.comitards) {
          for (const comitard_id in cercle.comitards) {
            ...
            if (comitard.encheres) {
              ...
              if (
                endEncheres.toDate().getTime() > Date.now() &&
                startEncheres.toDate().getTime() < Date.now()
              ) {
                ...
                for (const enchere_id in comitard.encheres) {
                  ...
                  candidateEncheres.push({
                    ...
                    comitard: `${comitard.name} "${comitard.nickname}" ${comitard.firstname}`,
                    enchere: `${
                      getCerclesDataWithNames()[enchere.sender]?.name ||
                      "Erreur"
                    } avec ${enchere.vote} fûts`,
                    vote: enchere.vote,
                    house: `${
              ...
              <CardContent>
                <DataGrid
                  ...
                  columns={[
                    ...
                    {
                      field: "enchere",
                      headerName: "Meilleure enchère",
                      sortable: false,
                      width: 200,
                    },
                    {
                      field: "endDate",
                      headerName: "Fin des enchères",
                      sortable: false,
                      width: 200,
                    },
                  ]}
              ...
              <CardContent>
                <DataGrid
                  ...
                  columns={[
                    ...
                    {
                      field: "endDate",
                      headerName: "Enchères terminées à",
                      sortable: false,
                      width: 200,
                    },
                  ]}
